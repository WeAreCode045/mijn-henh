 ...
 */
export function safelyGetImageUrl(image: string | PropertyImage | null | undefined): string | null {
...
export function normalizeImageCollection(
  images: (string | PropertyImage)[] | null | undefined
): PropertyImage[] {
 ...
 */
export function extractImageUrls(images: (string | PropertyImage)[] | null | undefined): string[] {
  if (!images || !Array.isArray(images)) return [];
 ...
 */
export function safelyGetImageId(image: string | PropertyImage | null | undefined): string | null {
  if (!image) return null;
