  ...
  return (
    <Card className="h-full">
      <Tabs defaultValue="agenda" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="px-6 pt-6 bg-primary-color">
          <TabsList className="grid grid-cols-5 h-12 w-full">
            <TabsTrigger value="agenda" className="flex items-center gap-2 text-white data-[state=active]:text-primary-color">
              <Calendar className="h-4 w-4" />
              <span>Agenda</span>
            </TabsTrigger>
            <TabsTrigger value="todo" className="flex items-center gap-2 text-white data-[state=active]:text-primary-color">
              <CheckSquare className="h-4 w-4" />
              <span>Todo</span>
            </TabsTrigger>
            <TabsTrigger value="communications" className="flex items-center gap-2 text-white data-[state=active]:text-primary-color">
              <MessageSquare className="h-4 w-4" />
              <span>Communications</span>
            </TabsTrigger>
            <TabsTrigger value="contacts" className="flex items-center gap-2 text-white data-[state=active]:text-primary-color">
              <Users className="h-4 w-4" />
              <span>Contacts</span>
            </TabsTrigger>
            <TabsTrigger value="documents" className="flex items-center gap-2 text-white data-[state=active]:text-primary-color">
